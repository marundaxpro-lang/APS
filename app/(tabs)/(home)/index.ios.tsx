...
const styles = StyleSheet.create({
  ...
  // Quick Actions Grid — 2×2 vertical card layout, icons fully visible
  ...
  quickCardTextGroup: { gap: 3 },
  quickCardLabel: { fontSize: 14, fontWeight: '700', color: C.text, letterSpacing: -0.2 },
